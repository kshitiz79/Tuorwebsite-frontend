...
import "./ActivityDisplay.css"; // You can remove this if using Tailwind for styling
      ...
      <section className="py-12 bg-white">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <button
            ...
            className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-gray-100 text-gray-800 p-3 rounded-full shadow-md hover:bg-gray-200"
          ...
          <button
            ...
            className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-gray-100 text-gray-800 p-3 rounded-full shadow-md hover:bg-gray-200"
      ...
      <section className="py-12 bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="text-gray-700">Our activities are led by experienced guides ensuring your safety and enjoyment.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <h3 className="text-xl font-semibold text-indigo-600 mb-4">Top-Notch Equipment</h3>
            <p className="text-gray-700">We provide high-quality equipment for all activities to ensure the best experience.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <h3 className="text-xl font-semibold text-indigo-600 mb-4">Unforgettable Experiences</h3>
            <p className="text-gray-700">Create memories that will last a lifetime with our well-curated activities.</p>
          </div>
        </div>
      </section>
    </div>
